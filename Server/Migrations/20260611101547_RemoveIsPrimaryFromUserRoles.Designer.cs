...
namespace Server.Migrations
{
    ...
    [Migration("20260611101547_RemoveIsPrimaryFromUserRoles")]
    partial class RemoveIsPrimaryFromUserRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Entities.ResourceProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Server.Models.Entities.ResourceProfileSkill", b =>
                {
                    b.Property<long>("ResourceProfileId")
                        .HasColumnType("bigint")
                        .HasColumnName("resource_profile_id");
            ...
            modelBuilder.Entity("Server.Models.Entities.ProjectAllocation", b =>
                {
                    ...
                    b.HasOne("Server.Models.Entities.ResourceProfile", null)
                        .WithMany()
